...
contract VerificationProcess is AccessControl, Ownable {
    bytes32 private constant ADMIN_ROLE = keccak256("ADMIN_ROLE");
    event Admin(address indexed _admin);
    event StepRecorded(
        uint256 indexed id,
   ...
   function GrantAdminRole(address _address)
    ...
    function getAllProducts() external view returns (OrderDetails[] memory) {
        return orders;
    }
